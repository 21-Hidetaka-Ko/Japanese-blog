...
ところが、アメリカ西海岸に来ると少し状況が変わっていることに気がつきます。アメリカのレストランでは、基本、店員が自分の近くにくるまで、わざわざ呼び寄せることは基本的にはタブーらしいです。店員も、「お客様は神様」のようなスタンスではありません。
...
つまり、「金さえ払えば、いい」というスタンスの人はこれから生きづらくなっているのです。
...
そう叫びたくなる瞬間でした。自分にとってのセーフティネットである。

今回の経験を通して、日常生活で、どんな困難に直面しても、知恵を振り絞れば、必ず策はあり、「問題は必ず解決できる」ということを学ぶことができました。

今回の経験を通して、文字で表現するのが難しいのですが、「生意気さとビッグマウスだけがとりえの自分だったら」と仮定して過去を振り返ってみると、「みんなは助けてくれたか？」に対する答えは、Noの確率がMaybeの確率より高くなる気がします。「ゲームオーバーしていたか？」に対する答えは、Yesの確率がMaybeの確率より高くなる気がするということがわかりました。
