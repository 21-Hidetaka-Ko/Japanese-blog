...
今のままだと列の名前が、V1やV2となっていて、何を表しているデータなのかいまいちわかりにくいので、Renameコマンドを使って列の名前を変えます。第二四半期の日付の最後が2015年6月30なので、`"Jun30_2015" = V3.x`と書きます。他も同様です。

`rename("企業概要" =V1, "Jun30_2015" = V3.x, "Jun30_2016" = V4.x, "Oct31_2014" =V3.y)`
...
`mutate(Jun30_2016 = str_replace(`Jun30_2016`, "△","-"), Jun30_2015 = str_replace(`Jun30_2015`, "△","-"), Oct31_2014 = str_replace(`Oct31_2014`, "△","-"))`
...
今度は、日付のデータタイプがcharacterになっているので、mdyコマンドを使って、Dateタイプに変えましょう。year列のヘッダーをクリックして、Convert toからMonth,Year,Dayを選びます。
...
タイトルなどを入力していきます。そして、矢印の場所をクリックしてShareボタンを押すと、シェアすることができます。
...
データがどのように加工されたり計算されたかの詳細もシェアすることができます。
